...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p>
                Your trainer has assigned you a new exercise plan at <strong>MTTM GYM</strong>.
            ...
            <div class="info-box">
                ...
                @if($attachmentPath)
                    <br>&#128206; Your exercise plan is attached to this email.
                @endif
            </div>

            <p>
                Follow your plan regularly for best results. If you have any questions,
                feel free to contact your trainer at the gym. 💪
            </p>
