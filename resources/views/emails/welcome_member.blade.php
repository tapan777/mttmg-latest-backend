...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <div class="greeting">Welcome, {{ $memberName }}! 🎉</div>

            <p>
                We are excited to have you as a member of <strong>MTTM GYM</strong>.
                Your registration has been completed successfully. Here are your membership details:
            </p>
            ...
            <div class="info-box">
                <table>
                    ...
                    <tr>
                        <td>Amount Paid</td>
                        <td><strong>&#8377; {{ $payingAmount }}</strong></td>
                    </tr>
                    <tr>
                        <td>Valid Until</td>
            ...
            <p>
                Please carry this email or your membership card when you visit the gym.
                Our team is always here to help you achieve your fitness goals. 💪
            </p>
