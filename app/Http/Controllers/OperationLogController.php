...
class OperationLogController extends Controller
{
    ...
    /**
     * Delete operation logs from the last 1 month (today back to 1 month ago).
    ...
    public function deleteOldLogs(Request $request)
    {
        ...
        $deleted = OperationLog::where('created_at', '>=', $from)->delete();
        return response()->json([
            'message' => 'Operation logs from the last 1 month (including today) have been deleted.',
